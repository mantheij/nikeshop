...
Command: npx gltfjsx@6.2.18 airforce.gltf 
...
export default function Model(props) {
    useFrame((state, delta) => {
        state.scene.children[0].rotation.y += delta;
    })
  const { nodes, materials } = useGLTF('/airforce.gltf')
  return (
    <group {...props} dispose={null} rotation={[Math.PI / 10, 0, 0]}>
